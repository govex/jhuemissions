...
function Filter({close, change, yearOptions, schoolOptions, error, filters}:{
  ...
  change: (event: SyntheticEvent, value: string, reason: AutocompleteChangeReason) => void, 
  yearOptions: {label:string, value: string[]}[],
  schoolOptions: {label:string, value:string, code:number}[],
  error?: string,
              ...
              >
                ...
                <AccordionDetails>
                  <Autocomplete 
                    ...
                    renderInput={(params) => <TextField {...params} name='school' />}
                    sx={{
